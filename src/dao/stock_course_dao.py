...
@log
def delete_ingredient_stock(id_ingredient, quantite, id_unite):
...
@log
def updtate_liste_course(id_ingredient, quantite, id_unite):
...
@log
def delete_ingredient_liste_course(id_ingredient, quantite, id_unite):
    """Méthode qui permet de supprimer une certaine quantité d'un ingredient dans
     la liste de course.
